...
- ###### `input()`함수와 `split()`함수를 결합해주는 경우
  ...
  하지만 해당 코드를 실행해 보면, 아래와 같이 에러가 발생하게 된다.<br>

  ![스크린샷(11)](https://github.com/Yoonsik-2002/conding-test/assets/83572199/88cba946-66d2-4a58-877c-5f269b61da83)<br>

  위 코드의 경우, `input()`함수를 통해 `11 12`를 명령 프롬프트에 입력하면, 정수형태의 문자열 `'11 12'`가 반환되게 된다. 그리고, `split()`함수는 이렇게 반환된 정수 형태의 문자열을 공백을 기준으로 나누어, 문자열 리스트 `['11', '12']`를 반환해준다.<br>
