...
# [코드업 100제] 출력 변환과 값 변환 - 6029
[문제 링크](https://codeup.kr/problem.php?id=6029)

16진수를 입력받아, 8진수로 출력하기<br>

`int()`함수는 첫 번째 인자로 전달된 값을 정수로 변환하는데 사용된다. 이때, 두 번째 인자로 전달된 값을 진법(base)으로 해석하여 출력해준다.<br>

즉, `int()`함수에 첫 번째 인자로 변환하고자 하는 값, 두 번째 인자로 해당 값의 진수를 전달해 주면, 변환하고자 하는 값을 두 번째 인자로 전달된 진법으로 해석하여, 정수로 변환해 주는 것이다. 아래 코드를 보자.<br>

![스크린샷(2)](https://github.com/Yoonsik-2002/coding-test/assets/83572199/7eae84a2-23d7-4ea5-97b6-c2f5e3bb0a41)<br>

위 코드는 `input()`함수를 통해 입력받은 값을 16진수로 해석하여, 해당 값을 그에 맞게 정수로 변환해준다. 즉, `A`를 입력하는 경우, 해당 값은 16진수로는 10을 나타내기 때문에 정수 10으로 변환하여 반환해 주는 것이다.<br>
<br>

이렇게 반환받은 10을 8진수로 출력해주는 코드는 다음과 같다.<br>

![스크린샷(4)](https://github.com/Yoonsik-2002/coding-test/assets/83572199/91f361d2-c6f2-4d08-918f-29db1270c6d3)<br>

---

<br><br>

# [코드업 100제] 출력 변환과 값 변환 - 6030
[문제 링크](https://codeup.kr/problem.php?id=6030)

영문자 1개를 입력받아, 10진수 유니코드로 변환하여 출력하기<br>

`ord()`함수는 주어진 문자의 유니코드 값을 반환해주는 파이썬 내장 함수이다.<br>

![스크린샷(6)](https://github.com/Yoonsik-2002/coding-test/assets/83572199/975fe6c7-8256-4e6d-9aca-4aa33c401cd1)<br>

---

<br><br>

# [코드업 100제] 출력 변환과 값 변호나 - 6031
[문제 링크](https://codeup.kr/problem.php?id=6031)

10진 정수 1개를 입력받아, 해당하는 유니코드 문자로 변환하여 출력하기<br>

`chr()`함수는 주어진 유니코드 값을 해당하는 문자로 변환해주는 파이썬 내장 함수이다.<br>

![스크린샷(8)](https://github.com/Yoonsik-2002/coding-test/assets/83572199/b9a0440c-6010-48ac-bf6a-62718833db4c)<br>
